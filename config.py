...
CHUNK_SIZE = 900        # cap on one section-chunk; above the longest section seen (711 chars)
CHUNK_OVERLAP = 100     # only used if a section ever exceeds CHUNK_SIZE and must be split further
